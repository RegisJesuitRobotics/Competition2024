...
public class StructTelemetryEntry<T> extends PrimitiveTelemetryEntry {
    ...
    public StructTelemetryEntry(String path, Struct<T> struct, boolean shouldNT, boolean shouldLazyLog) {
        super(shouldLazyLog);
    ...
    /**
     * Appends a value to the log. If lazy logging, only appends if the value is a different object from the last value, and they are not #equals.
