...
public class TelemetryPigeon2 extends Pigeon2 {
    ...
    public TelemetryPigeon2(int deviceId, String telemetryPath, String canbus, boolean tuningMode) {
        ...
        angularVelocityXEntry = new DoubleTelemetryEntry(telemetryPath + "angularVelocityX", tuningMode);
        angularVelocityYEntry = new DoubleTelemetryEntry(telemetryPath + "angularVelocityY", tuningMode);
        angularVelocityZEntry = new DoubleTelemetryEntry(telemetryPath + "angularVelocityZ", tuningMode);
