...
/**
 * For a controller that looks like a playstation controller but acts like an xbox. A subclass of
 * {@link XboxController} with {@link Trigger} factories for command-based.
 *
 * @see XboxController
 */
