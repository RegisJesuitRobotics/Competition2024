...
public class Autos {
  ...
  public Autos(
    ...
    NamedCommands.registerCommand("FarShoot", farShootNote());
    ...
    return Commands.deadline(
        Commands.sequence(
                ...
                ScoringCommands.transportCloseSpeakerCommand(transportSubsystem)
                    .until(() -> !transportSubsystem.atSensor()))
            .andThen(Commands.waitSeconds(0.1), transportSubsystem.stopMovementCommand()),
        ScoringCommands.setSetpointFarShoot(shooterSubsystem),
        ElevatorWristCommands.farPositionCommand(elevatorSubsystem, wristSubsystem));
  }
