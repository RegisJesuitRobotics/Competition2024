...
public class WheelRadiusCharacterization extends Command {
  ...
  private DoubleTelemetryEntry drivePosLog =
      new DoubleTelemetryEntry("drive/RadiusCharacterization/DrivePosition", true);
  private DoubleTelemetryEntry accumGyroYawRadsLog =
      new DoubleTelemetryEntry("drive/RadiusCharacterization/AccumGyroYawRads", true);
  private DoubleTelemetryEntry currentEffectiveWheelRadiusLog =
      new DoubleTelemetryEntry("drive/RadiusCharacterization/CurrentWheelRadiusInches", true);

  private static final double driveRadius =
      Constants.SwerveConstants.MODULE_TRANSLATIONS[0].getNorm();
  ...
  public WheelRadiusCharacterization(
      SwerveDriveSubsystem drive, Direction omegaDirection, double speed) {
    this.drive = drive;
