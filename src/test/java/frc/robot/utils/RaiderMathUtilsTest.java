...
class RaiderMathUtilsTest {
  @Test
  void calculateContinuousInputSetpoint_0_0_0() {
    assertEquals(0, RaiderMathUtils.calculateContinuousInputSetpoint(0, 0));
  }

  @Test
  void calculateContinuousInputSetpoint_2PI_0_2PI() {
    assertEquals(Math.PI * 2, RaiderMathUtils.calculateContinuousInputSetpoint(Math.PI * 2, 0));
  }

  @Test
  void calculateContinuousInputSetpoint_0_2PI_0() {
    assertEquals(0, RaiderMathUtils.calculateContinuousInputSetpoint(0, Math.PI * 2));
  }

  @Test
  void calculateContinuousInputSetpoint_3PI_PI_3PI() {
    assertEquals(
        Math.PI * 3, RaiderMathUtils.calculateContinuousInputSetpoint(Math.PI * 3, Math.PI));
  }
  ...
  void applyCircleDeadZone_InsideCircle_NoChange() {
    assertEquals(
        ...
        RaiderMathUtils.applyCircleDeadZone(new Translation2d(0.5, 0.5), 1.0));
  }
  ...
  void applyCircleDeadZone_InsideCircle_NonOneMax_NoChange() {
    assertEquals(
        ...
        RaiderMathUtils.applyCircleDeadZone(new Translation2d(1.0, 1.5), 10.0));
  }
  ...
  void applyCircleDeadZone_OutsideCircle_Normalized() {
    assertEquals(
        ...
        RaiderMathUtils.applyCircleDeadZone(new Translation2d(1.0, 1.0), 1.0));
  }
